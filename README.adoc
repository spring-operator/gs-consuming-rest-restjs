...
== What you'll need
 ...
 - Bower installed as a global node.js link:/understanding/javascript-package-managers[package]
...
link:/understanding/javascript-package-managers[JavaScript packages]
...
Next, use link:/understanding/javascript-package-managers[bower] to 
install rest.js and an link:/understanding/javascript-modules[AMD module] 
...
This link:/understanding/javascript-modules[module] uses simple DOM 
